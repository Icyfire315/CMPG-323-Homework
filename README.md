...
## What does it solve?
Nothing really, it just a code to caputure users' input from a text bot and combo box, add them to a list to be either read, write or append. Like i said nothing special about it.
